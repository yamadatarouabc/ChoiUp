...
2. **教材の評価一覧を確認**
   ...
   - 例：「Railsの基本的なCRUDができる人」が「3. ちょうどいい(適度に考えさせられる)」と評価
   - 例：「プログラミング初めて」の人が「5. とても難しい(かなり手応えがある)」と評価
3. **自分のレベルと照らし合わせて判断**
...
教材登録で登録する説明は現状以下を想定しています。
公式サイトの説明を貼り付けるイメージです。
...
acts-as-taggable-on（分野・目的など）については要検討
- ページネーション：kaminari
- 開発環境 : docker
