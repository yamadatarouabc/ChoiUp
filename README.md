...
教材に対して「体感難易度（5段階）」と自分の開始レベルをセットで記録することで、
...
### 用語メモ（体感難易度＝教材の絶対難易度ではない）

本サービスでは、教材そのものの難易度ではなく、 **「学習者が感じた難易度」** を記録します。

**例：**
- 同じ「プロを目指す人のためのRuby入門」という教材でも：
  - プログラミング初心者が学習した場合 → 「5. とても難しい」と感じる
  - Pythonの経験者が学習した場合 → 「2. 優しい」と感じる

このように、 **「誰が・どのレベルで学習したか」によって体感難易度は変わります。**
...
このサービスは、過去の自分のように「頑張って選んだのに、結局自分に合わなかった」という時間の無駄を減らしたい、そして学習者が「自分の開始レベル」と「体感難易度」をセットで記録することで、次の学習者が**"今の自分にとっての 少し上"**を事前に判断でき、全ての学習者が最短距離で成長できる環境を作りたい、という思いから生まれました。
...
2. **教材の評価一覧を確認**
   - 他の学習者が「どのレベルから始めて」「どう感じたか(体感難易度（5段階）)」を見る
   - 例：「Railsの基本的なCRUDができる人（基礎レベル（簡単な実装ができる））」が「3. ちょうどいい(適度に考えさせられる)」と評価
   - 例：「プログラミングが初めて（全くの初心者（この分野に初めて触れる））」の人が「5. とても難しい(かなり手応えがある)」と評価
3. **自分のレベルと照らし合わせて判断**
   - 「自分と同じレベルの人が 3. ちょうどいい(適度に考えさせられる) と評価している教材」を選ぶ
   - 事前に難易度のミスマッチを避けられる
4. **教材を選んで学習開始**
...
- **パーソナライズされたおすすめ機能**
   - 学習履歴や「いいね」した教材の傾向から、ユーザーに最適な「3. ちょうどいい(適度に考えさせられる)教材」を提案
...
2. **学習開始時の自分のレベルを記録**（自由記述は現状する予定はありません。）
   - 例：「HTML/CSSは書けるが、JavaScriptは初めて」
   - 例：「Railsの基本的なCRUDは理解している」
3. **体感難易度を選択**
   - `1. とても優しい(サクサク進められる)~5. とても難しい(かなり手応えがある)の中から選択`
4. **評価を投稿**
...
| 項目 | 既存サービス | 本サービス |
|------|------------|-----------|
| **評価の形式** | 総合評価（★1〜5）や満足度が中心 | **学習者のレベル付きの体感難易度（5段階）**を記録する |
...
- 既存サービスでは、「良い教材」は見つかるが、「自分にとっての 少し上」を探すのが難しい
- 本サービスでは、**「自分と同じレベルの人が ちょうどいい と評価した教材」を優先的にチェックできる**
...
教材登録で登録するURLは現状以下を想定しています。
本であれば、その出版社のURLの該当ページ
YouTubeや、Udemyなどwebサイトであればqiita, zennなど。
また公式ドキュメントなどに関しても同様にURLです。

教材登録で登録する説明は、現時点において、公式サイトやAmazonなどの説明文をユーザーがコピー＆ペーストすることを想定しています。
...
- 評価へのいいね機能
  ...
  - いいね数の多い評価を優先表示
- 評価のフィルタリング機能
  - 「3. ちょうどいい(適度に考えさせられる)と評価した人」だけを表示
  - 「自分と同じレベルの人の評価」を優先表示
...
```
↑についてはアプリの理想像です。
また良いねで最適な教材を絞るのか、ユーザーのレベル情報から提案する機能についてはまだ検討中です。
